...
* The following dependencies are not known to work with Spring Native: 'Spring Boot DevTools, Spring HATEOAS, Spring
...
```
$ docker run --rm -p 8080:8080 StreamObserver:0.0.1-SNAPSHOT
```
